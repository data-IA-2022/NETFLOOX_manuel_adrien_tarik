...
def repartition_flms_sans_notes(table):
...
def repartition_notes_2_films(table):
...
def repartition_items_par_types(table, red_color=False):
...
def nombre_films_difuses_par_regions(table):
...
if __name__ =='__main__':
    ...
    nombre_films_difuses_par_regions(dts['analyses']['region_diffusion_films'])  
    ...
    repartition_notes_2_films(dts['analyses']['notes'])  
    repartition_items_par_types(dts['analyses']['types'])  
    repartition_items_par_types(dts['analyses']['types'][1:-1], True)  
    repartition_flms_sans_notes(dts['analyses']['prop_notes_null'])
